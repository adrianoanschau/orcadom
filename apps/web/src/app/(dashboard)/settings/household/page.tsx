...
export default function HouseholdSettingsPage() {
  ...
  return (
    <section className="space-y-8">
      <div>
        <h1 className="font-display text-[28px] font-semibold">Família / espaço</h1>
        <p className="mt-2 text-sm text-ink-soft">
          Contas, orçamentos e lançamentos são compartilhados neste espaço.
          {households.length > 1 ? ' Troque de espaço pelo seletor do topo.' : ''}
        </p>
      </div>
      ...
      <div className="rounded-lg bg-surface p-6">
        <h2 className="font-display text-[21px] font-medium">Nome do espaço</h2>
        {isOwner ? (
          <form
      ...
      <div className="rounded-lg bg-surface p-6">
        <h2 className="font-display text-[21px] font-medium">Membros</h2>
      ...
      {isOwner ? (
        <div className="rounded-lg bg-surface p-6">
          <h2 className="font-display text-[21px] font-medium">Convites</h2>
          <p className="mt-2 text-sm text-ink-soft">
            A pessoa precisa criar (ou já ter) uma conta com o mesmo e-mail e abrir o link do convite.
          </p>
          <form
            className="mt-4 flex flex-wrap gap-3"
            onSubmit={(event) => {
